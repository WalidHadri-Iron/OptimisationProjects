        ...
        try:
            ...
            for day in self.Days:
                ...
                for i in range(len(day.TechnicianRoutes)):
                    ...
                    self._checkError('Technician %d is not allowed to make more than one route on day %d' %(day.TechnicianRoutes[i].ID, day.dayNumber), techniciansUsed[technician.ID-1][day.dayNumber-1] == 0)
