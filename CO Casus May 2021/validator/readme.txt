...
This folder contains an example instance named example002, together with a valid solution for this instance. You can use these to test the validator.

To validate instance example002, execute the validator with arguments:
python Validate.py --instance example002.txt --solution example002sol.txt

It should give output like this:

Solution example002.sol is a valid solution
